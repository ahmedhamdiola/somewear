...
export const createProductVariantController = async (
  ...
  try {
    const productVariant =
      await ProductVariantService.createProductVariantService(req.body);
...
export const getProductVariantByIdController = async (
  ...
  try {
    ...
    const productVariant =
      await ProductVariantService.getProductVariantByIdService(id);
...
export const getProductVariantsByProductIdController = async (
  req: Request,
  res: Response,
) => {
  try {
    ...
    const productVariants =
      await ProductVariantService.getProductVariantsByProductIdService(
        productId,
      );
...
export const updateProductVariantController = async (
  ...
  try {
    ...
    const updatedVariant =
      await ProductVariantService.updateProductVariantService(id, req.body);
    return successResponse(
      res,
      updatedVariant,
