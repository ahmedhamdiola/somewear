...
export const getCartItemsByUserIdController = async (
  req: AuthRequest,
  res: Response,
) => {
  try {
    ...
    const cartItems =
      await CartItemsService.getCartItemsByUserIdService(userId);
...
export const updateCartItemQuantityController = async (
  ...
  try {
    ...
    const updated = await CartItemsService.updateCartItemQuantityService(
      id,
      quantity,
    );
...
export const deleteCartItemsByUserIdController = async (
  req: AuthRequest,
  res: Response,
) => {
  try {
